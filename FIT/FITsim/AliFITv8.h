...
private:
  ...
  static const Float_t sEps; // 0.05;
  // offset found to potentially remove overlaps
  static const Float_t sXoffset; // 0.3027999999999995;
  static const Float_t sYoffset; //-0.6570999999999998;

  // frame 1 has a longer side horizontal
  static const Float_t sFrame1X;    // 21.500;
  static const Float_t sFrame1Y;    // 13.705;
  static const Float_t sFrame1PosX; // 7.9278 - sXoffset;
  static const Float_t sFrame1PosY; // 9.2454 - sYoffset;
  static const Float_t sRect1X;     // 15;
  static const Float_t sRect1Y;     // 1.33;
  static const Float_t sRect2X;     // 2.9;
  static const Float_t sRect2Y;     // 12.2;
  static const Float_t sRect3X;     // 1.57;
  static const Float_t sRect3Y;     //.175;
  static const Float_t sRect4X;     // 5.65;
  static const Float_t sRect4Y;     // 1.075;
  // frame 2 has a longer side vertical
  static const Float_t sFrame2X;    // 13.930;
  static const Float_t sFrame2Y;    // 21.475;
  static const Float_t sFrame2PosX; // 10.1428 - sXoffset;
  static const Float_t sFrame2PosY; //-8.3446 - sYoffset;
  static const Float_t sRect5X;     // 1.33;
  static const Float_t sRect5Y;     // 12.1;

  static const Float_t sRect6X; //.83;
  static const Float_t sRect6Y; // 3.0;
  static const Float_t sRect7X; // 13.1;
  static const Float_t sRect7Y; // 3.0;
  static const Float_t sRect8X; // 1.425;
  static const Float_t sRect8Y; // 5.5;

  // both frame boxes are the same height
  static const Float_t sFrameZ; // 5.700;
  static const Float_t sMountZ; // 1.5;

  // PMT socket dimensions
  static const Float_t sPmtSide; // 5.950;
  static const Float_t sPmtZ;    // 3.750;

  // quartz radiator socket dimensions
  // static const Float_t sQuartzRadiatorSide; //5.350;
  // static const Float_t sQuartzRadiatorZ; //1.950;
  static const Float_t sQuartzRadiatorSide; // 5.40;
  static const Float_t sQuartzRadiatorZ;    // 2.0;
  // for the rounded socket corners
  static const Float_t sCornerRadius; //.300;

  // bottom plates on the frame
  static const Float_t sPlateSide;   // 6.000;
  static const Float_t sBasicPlateZ; // 0.200;
  static const Float_t sCablePlateZ; // 0.500;
  static const Float_t sFiberHeadX;  // 0.675 * 2;
  static const Float_t sFiberHeadY;  // 0.275 * 2;

  // plate transformations
  static const Float_t sOpticalFiberPlateZ;      // 0.35;
  static const Float_t sPlateSpacing;            // 6.100;
  static const Float_t sPlateDisplacementDeltaY; // 1.33;
  static const Float_t sPlateDisplacementX;      // sPlateSpacing + 0.3028;
  static const Float_t
      sPlateDisplacementY;           // 12.8789 - sPlateDisplacementDeltaY;
  static const Float_t sPlateGroupZ; //-sFrameZ / 2 - sOpticalFiberPlateZ;

  // quartz & PMT socket transformations
  static const Float_t sQuartzHeight;     //-sFrameZ / 2 + sQuartzRadiatorZ / 2;
  static const Float_t sPmtHeight;        // sFrameZ / 2 - sPmtZ / 2;
  static const Float_t sPmtCornerTubePos; //-.15;
  static const Float_t sPmtCornerPos;     // 2.825;
  static const Float_t sEdgeCornerPos[2]; //{-6.515, -.515};
  static const Float_t sQuartzFrameOffsetX; //-1.525;
  static const Float_t sPos1X[3];
  static const Float_t sPos1Y[4]; //{3.6275, -2.4725, 2.2975, -3.8025};
  static const Float_t sPos2X[4]; //{3.69, -2.410, 2.360, -3.740};
  static const Float_t sPos2Y[3]; //{7.6875, 1.5875, -4.5125};
                                  // END: Support structure constants

  static const Float_t fPosModuleAx[24];
  /* = { -12.2, -6.1, 0,        6.1,        12.2,       -12.2,   -6.1,  0,
       6.1,   12.2, -13.3743, -7.2742999, 7.27429999, 13.3743, -12.2, -6.1,
       0,     6.1,  12.2,     -12.2,      -6.1,       0,       6.1,   12.2};*/

  static const Float_t fPosModuleAy[24];
  /* = {12.2, 12.2,  13.53, 12.2,   12.2,  6.1,
                        6.1,  7.43,  6.1,   6.1,    0,     0,
                        0,    0,     -6.1,  -6.1,   -7.43, -6.1,
                        -6.1, -12.2, -12.2, -13.53, -12.2, -12.2};*/
  static const Float_t fstartC[3];  ///= {20., 20, 5.5};
  static const Float_t fstartA[3];  //= {20., 20., 5};
  static const Float_t fInStart[3]; //= {2.9491, 2.9491, 2.5};
